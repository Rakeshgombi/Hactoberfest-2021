'''Hello everyone!! I am Pratyush and below is python code to find the remainder when an exponents is divided by an integer,using binary exponentiation with remainderisation at each recursion(step).
